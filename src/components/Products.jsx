    ...
    <div>
      ...
      <div className="container container1 bor">
        <div className="right right1 bor">
          <Link to="electronics" >
            <div className="caty" onClick={() => setcaty("electronics")}>
              Electronics
            </div>
          </Link> 
          <Link>
          <div className="caty" onClick={() => setcaty("jewelery")}>
            Jewelery
          </div>
          </Link>
          <Link>
          <div className="caty" onClick={() => setcaty("women's clothing")}>
            Women's Clothing
          </div>
          </Link>
          <Link>
          <div className="caty" onClick={() => setcaty("men's clothing")}>
            Men's Clothing
          </div>
          </Link>
        </div>
